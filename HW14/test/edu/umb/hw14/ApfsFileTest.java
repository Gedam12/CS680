...
class ApfsFileTest {
	...
	ApfsFile b = new ApfsFile(applications, "b", 60, localTime,"ApfsFile",localTime);
	ApfsFile c = new ApfsFile(home, "c", 40, localTime,"ApfsFile",localTime);
	ApfsFile d = new ApfsFile(home, "d", 60, localTime,"ApfsFile",localTime);
	ApfsFile e = new ApfsFile(code, "e", 5, localTime,"ApfsFile",localTime);
	ApfsFile f = new ApfsFile(code, "f", 25, localTime,"ApfsFile",localTime);
